...
const AppDevelopment = () => {
  const cardsContent = [
    ...
    {
      title: "UI/UX Design",
      description: "Designing engaging interfaces and user flows for a premium experience.",
  ...
  const stats = [
    { number: "200+", label: "Apps Developed" },
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 left-1/4 w-72 h-72 bg-gradient-to-r from-pink-400 to-rose-400 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '4s' }}></div>
      ...
      <div className="absolute bottom-20 left-20 w-5 h-5 bg-pink-400 rounded-full animate-bounce" style={{ animationDelay: '3s' }}></div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        >
          ...
          <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-purple-800 to-indigo-800 bg-clip-text text-transparent leading-tight">
            Create Amazing
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            We build innovative mobile applications that engage users, drive business growth, 
        ...
        >
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-8 rounded-3xl shadow-2xl">
            ...
            <p className="text-purple-100 mb-6 text-lg">
              Let's create a mobile app that users love and drives your business forward
            </p>
