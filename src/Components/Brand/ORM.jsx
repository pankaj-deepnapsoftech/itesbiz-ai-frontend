...
import { MdSecurity, MdTrendingUp, MdPsychology } from "react-icons/md";
...
const ORM = () => {
  ...
  const stats = [
    ...
    { number: "500+", label: "Brands Protected" },
        ...
        >
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-8 rounded-3xl shadow-2xl">
            ...
            <p className="text-green-100 mb-6 text-lg">
              Let's build a bulletproof online presence together
            </p>
