...
import { MdTrendingUp, MdPsychology, MdShare } from "react-icons/md";
...
const SocialMedia = () => {
  const cardsContent = [
    ...
    },
    {
      ...
      description: "We track performance metrics and deliver insightful reports to guide future strategies.",
  ...
  const stats = [
    { number: "2M+", label: "Followers Reached" },
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 left-1/4 w-72 h-72 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '4s' }}></div>
