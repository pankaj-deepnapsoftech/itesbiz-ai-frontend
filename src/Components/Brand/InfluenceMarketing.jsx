...
import { MdTrendingUp, MdPsychology, MdVerified } from "react-icons/md";
...
const InfluenceMarketing = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      text: "Authentic Partnerships",
    },
  ];

  const stats = [
    { number: "10K+", label: "Influencers Network" },
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 -right-20 w-96 h-96 bg-gradient-to-r from-pink-400 to-rose-400 rounded-full opacity-15 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="absolute top-40 right-20 w-3 h-3 bg-pink-400 rounded-full animate-bounce" style={{ animationDelay: '2s' }}></div>
        ...
        >
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-8 rounded-3xl shadow-2xl">
            <h2 className="text-3xl font-bold text-white mb-4">
              Ready to Leverage Influencer Power?
            </h2>
            <p className="text-purple-100 mb-6 text-lg">
              Let's connect you with the right influencers to amplify your brand
            </p>
