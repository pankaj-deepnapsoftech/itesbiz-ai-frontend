  ...
  const cardsContent = [
    {
      ...
      description:
        " Store and manage all employee records in one place.",
    ...
    },
    {
      ...
      description:
        " Generate salaries with tax and compliance integration.",
    ...
    },
    {
      ...
      description:
        "Employees and managers can use HRM tools on the go.",
    ...
    },
    {
      ...
      description:
        "Connect HRM with ERP, CRM, and accounting systems.",
    ...
    },
    {
      ...
      description:
        "Get insights into workforce productivity and HR trends.",
    ...
    },
    {
      ...
      description:
        "Track working hours, shifts, and leave requests.",
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        HRM Development
          ...
          Our <strong>HRM</strong> streamlines payroll, performance, and employee management with an all-in-one automated solution.
          </p>
