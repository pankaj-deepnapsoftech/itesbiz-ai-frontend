  ...
  const cardsContent = [
    {
      ...
      description:
        "Capture, qualify, and nurture leads with ease.",
    ...
    },
    {
      ...
      description:
        "Visualize your sales cycle from prospect to closure.",
    ...
    },
    {
      ...
      description:
        "Email, SMS, and WhatsApp integration for seamless outreach.",
    ...
    },
    {
      ...
      description:
        "Gain insights into sales, performance, and customer trends.",
    ...
    },
    {
      title: "Mobile CRM ",
      description:
        "Access data anytime, anywhere with mobile-friendly features  .",
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        >
          ...
          Our  <strong>CRM</strong> helps businesses manage leads, track sales, and build lasting customer relationships. Simple, scalable, and smart for startups to enterprises.
          </p>
