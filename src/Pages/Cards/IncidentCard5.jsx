          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-gray-600 font-normal text-sm mt-1">
                Describe your flow and AI agents will built it for you.
              </p>
            </div>
            ...
            <div className="mt-3 text-left space-y-2">
              <div className="bg-blue-100 border-l-4 border-blue-500 p-2 rounded-lg text-sm">
                <strong className="text-blue-800">🔧 Remediation</strong>
                <p className="text-gray-700">Vulnerability patch deployed.</p>
              </div>

              <div className="bg-green-100 border-l-4 border-green-500 p-2 rounded-lg text-sm">
                <strong className="text-green-800">🔒 Security Fix</strong>
                <p className="text-gray-700">Enhanced firewall rules applied.</p>
              </div>
            </div>
          </motion.div>
