          ...
          >
            ...
            <div className="text-left">
              <p className="text-gray-600 font-normal text-sm mt-1">
               Steps taken by AI Agents for a aleave of absence.
              </p>
            </div>
            ...
            <div className="mt-3 text-left space-y-2">
              <div className="bg-blue-100 border-l-4 border-blue-500 p-2 rounded-lg text-sm">
                <strong className="text-blue-800"> ✅ Clarified leave policy details.</strong>
              </div>

              <div className="bg-green-100 border-l-4 border-green-500 p-2 rounded-lg text-sm">
                <strong className="text-green-800">✅ Confirmed leave and return timeline.</strong>
              </div>
            </div>
          </motion.div>
